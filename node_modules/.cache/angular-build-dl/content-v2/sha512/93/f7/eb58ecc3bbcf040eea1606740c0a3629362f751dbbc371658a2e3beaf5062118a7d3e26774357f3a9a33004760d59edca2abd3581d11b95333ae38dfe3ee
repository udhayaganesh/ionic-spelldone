...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppCoreSdconfigTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var backendHost = location.host.indexOf('localhost') == 0 ? 'http://localhost:8080/api' : 'https://spelldoneapi.appspot.com/api'; // let backendHost = location.host.indexOf('localhost') == 0 ? 'http://localhost:8080/api' : 'https://spelldoneapi-test.appspot.com/api';
